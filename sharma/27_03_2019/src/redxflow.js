...
import { EditData, addNewData, addBackendData } from './actions/actions';
...
class Redxflow extends React.Component {
  ...
  addBackendData = () => {
    debugger;
    console.log('(After Click)1:addBackendData() called from component');
  ...
  render() {
    ...
    console.log(
      ' (After Click)7: Response Came :=>' +
        JSON.stringify(this.props.starwardata)
    );
    // let a = this.props.starwardata.results;
    // console.log(
    //   '(Before Click)3.Type of starwardata is :' +
    //     typeof a +
    //     '.....' +
    //     ' Resullt is' +
    //     JSON.stringify(a)
